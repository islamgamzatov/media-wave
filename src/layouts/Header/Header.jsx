	...
	return (
		<header 
			className={classNames('header', {
				'is-fixed': isFixed, // Этот класс добвится только тогда, когда мы в metadata конкретной страницы написали isHeaderFixed = true. Нужно это, потому что только на главной страницы первый блок лезет под хедер.
			})}
			data-js-overlay-menu=""
		> { /* Значение подобным атрибутом как пустую строку стоит указывать, потому что того требует JSX синтаксис */ }
